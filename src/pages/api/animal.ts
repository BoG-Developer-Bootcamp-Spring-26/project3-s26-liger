...
export default async function handler(
  ...
  if (req.method === "POST") {
    try {
      ...
      if (!profilePicture || profilePicture === "") {
        pfp =
          "https://www.endcottagevets.co.uk/images/headers/end-cottage-default-int-983.webp";
      }
    ...
    try {
      ...
      if (newProfilePicture) {
        ...
        updateFields.profilePicture =
          "https://atlantahumane.org/wp-content/uploads/2025/11/dog-hero.jpg";
      }
  ...
  if (req.body === "PATCH") {
    try {
      ...
      const newAnimal = updateAnimal(id, {
        name,
        breed,
        owner,
        hoursTrained,
      ...
      return res
        .status(200)
        .json({ message: "Animal updated successfully!", animal: newAnimal });
    } catch (e) {
      return res.status(500).json({ error: "Error updating animal." });
    }
  }
