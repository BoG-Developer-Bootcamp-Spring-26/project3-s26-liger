...
export const Sidebar = ({ currentPage, user, isAdmin }: Props) => {
  return (
    <div className="flex flex-col h-full w-56 pt-4 pb-2 px-5 shadow">
      <div>
        <SidebarPage
      ...
      {isAdmin ? (
        <div>
          ...
          <p className="text-[#565252] font-medium mx-3 mt-3 mb-1">
            Admin access
          </p>
          <SidebarPage
      ...
      <div className="mt-auto">
        ...
        <div className="flex flex-row items-center">
          <div className="rounded-full h-9 w-9 text-2xl truncate text-center p-0.5 font-bold bg-primary-red text-white mr-3">
          ...
          <div className="ml-auto">
            ...
            >
              <Image
                src={logoutLogo}
                alt="logout logo"
                className="self-center h-5 w-auto"
              />
            </Link>
          </div>
        </div>
